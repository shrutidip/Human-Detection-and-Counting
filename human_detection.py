...
def argsParser():
    ...
    arg_parse.add_argument("-v", "--video", default=None, help="")
    arg_parse.add_argument("-i", "--image", default=None, help="")
    #arg_parse.add_argument("-c", "--camera", default=False, help="True")
